...
class Sighting extends amplify_core.Model {
  ...
  bool get isTimeClaimed {
    try {
      return _isTimeClaimed!;
    } catch(e) {
      throw amplify_core.AmplifyCodeGenModelException(
          amplify_core.AmplifyExceptionMessages.codeGenRequiredFieldForceCastExceptionMessage,
          recoverySuggestion:
  ...
  const Sighting._internal({required this.id, required species, required photo, required latitude, required longitude, city, displayLatitude, displayLongitude, required timestamp, description, user, required isTimeClaimed, createdAt, updatedAt}): _species = species, _photo = photo, _latitude = latitude, _longitude = longitude, _city = city, _displayLatitude = displayLatitude, _displayLongitude = displayLongitude, _timestamp = timestamp, _description = description, _user = user, _isTimeClaimed = isTimeClaimed, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Sighting({String? id, required String species, required String photo, required double latitude, required double longitude, String? city, double? displayLatitude, double? displayLongitude, required amplify_core.TemporalDateTime timestamp, String? description, User? user, required bool isTimeClaimed}) {
  ...
  bool operator ==(Object other) {
    ...
    return other is Sighting &&
      ...
      _user == other._user &&
      _isTimeClaimed == other._isTimeClaimed;
  }
  ...
  String toString() {
    ...
    buffer.write("isTimeClaimed=" + (_isTimeClaimed != null ? _isTimeClaimed!.toString() : "null") + ", ");
  ...
  Sighting copyWith({String? species, String? photo, double? latitude, double? longitude, String? city, double? displayLatitude, double? displayLongitude, amplify_core.TemporalDateTime? timestamp, String? description, User? user, bool? isTimeClaimed}) {
    return Sighting._internal(
      id: id,
      ...
      user: user ?? this.user,
      isTimeClaimed: isTimeClaimed ?? this.isTimeClaimed);
  }
  ...
  Sighting copyWithModelFieldValues({
    ...
    ModelFieldValue<bool>? isTimeClaimed
  }) {
    return Sighting._internal(
      id: id,
      ...
      isTimeClaimed: isTimeClaimed == null ? this.isTimeClaimed : isTimeClaimed.value
    );
  }
  ...
  Sighting.fromJson(Map<String, dynamic> json)  
    : id = json['id'],
      ...
      _user = json['user'] != null
        ...
        : null,
      _isTimeClaimed = json['isTimeClaimed'],
      _createdAt = json['createdAt'] != null ? amplify_core.TemporalDateTime.fromString(json['createdAt']) : null,
      _updatedAt = json['updatedAt'] != null ? amplify_core.TemporalDateTime.fromString(json['updatedAt']) : null;
  
  Map<String, dynamic> toJson() => {
    'id': id, 'species': _species, 'photo': _photo, 'latitude': _latitude, 'longitude': _longitude, 'city': _city, 'displayLatitude': _displayLatitude, 'displayLongitude': _displayLongitude, 'timestamp': _timestamp?.format(), 'description': _description, 'user': _user?.toJson(), 'isTimeClaimed': _isTimeClaimed, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final ISTIMECLAIMED = amplify_core.QueryField(fieldName: "isTimeClaimed");
